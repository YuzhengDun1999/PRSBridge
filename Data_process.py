    ...
    with open(sumstat_file) as ff:
        ...
        for line in ff:
            ...
            if ll[3] in ATGC and ll[4] in ATGC:
                ...
                sumstat_dict['SNP'].append(ll[2])
                sumstat_dict['A1'].append(ll[3])
                sumstat_dict['A2'].append(ll[4])
                sumstat_dict['frq'].append(float(ll[5]))
                sumstat_dict['P'].append(float(ll[6]))
                sumstat_dict['beta'].append(float(ll[7]))
                sumstat_dict['SE'].append(float(ll[8]))
                sumstat_dict['N'].append(int(ll[9]))
