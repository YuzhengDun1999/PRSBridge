...
class SamplerOptions():
    ...
    def __init__(self, coef_sampler_type,
        ...
        """
        if coef_sampler_type not in ('cholesky', 'cg', 'hmc', 'woodbury', 'univariate'):
    ...
    @staticmethod
    def pick_default_and_create(coef_sampler_type, options):
        ...
        if coef_sampler_type not in (None, 'cholesky', 'cg', 'hmc', 'woodbury', 'univariate'):
...
class MarkovChainManager():
    ...
    def __init__(self, n_pred, n_unshrunk, model_name):
        self.n_pred = n_pred
    ...
    def pack_parameters(self, coef, lscale, gscale):
        state = {
            'coef': coef,
            'local_scale': lscale,
            'global_scale': gscale,
